...
class AStar(BestFirstSearch):
    ...
    def _calc_node_expanding_priority(self, search_node: SearchNode) -> float:
        ...
        assert isinstance(self.heuristic_function, HeuristicFunction)
    ...
    def _open_successor_node(self, problem: GraphProblem, successor_node: SearchNode):
        ...
        """
        cloesd_node: SearchNode = self.close.get_node_by_state(successor_node.state)
        opened_node: SearchNode = self.open.get_node_by_state(successor_node.state)
        if opened_node is not None:
